...
define("MMDVMLOGPATH", "/opt/dmr/log/");
define("MMDVMLOGPREFIX", "MMDVM");
define("MMDVMINIPATH", "/opt/dmr/ini/");
define("MMDVMINIFILENAME", "mmdvmhost");
define("MMDVMHOSTPATH", "/opt/dmr/MMDVMHost/");
define("DMRGATEWAYLOGPATH", "/opt/dmr/log");
define("DMRGATEWAYLOGPREFIX", "DMRGateway");
define("DMRGATEWAYINIPATH", "/opt/dmr/ini/");
define("DMRGATEWAYINIFILENAME", "DMRGateway");
define("DMRGATEWAYPATH", "/opt/dmr/DMRGateway/");
define("DMRIDDATPATH", "/opt/dmr/MMDVMHost/");
define("LINKLOGPATH", "/opt/dmr/log");
define("REFRESHAFTER", "20");
...
function getMMDVMLog() {
	...
	$logLines1 = array();
	$logLines2 = array();
	if (file_exists(MMDVMLOGPATH."/".MMDVMLOGPREFIX.".log")) {
		$logPath = MMDVMLOGPATH."/".MMDVMLOGPREFIX.".log";
    ...
    case "DMR Slot 1":
        foreach ($logLines as $logLine) {
        	if(strpos($logLine,"unable to decode the network CSBK")) {
				continue;
			} else if(substr($logLine, 27, strpos($logLine,",") - 27) == "Slot 1") {
				$to = "";
